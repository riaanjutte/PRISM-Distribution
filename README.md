...
- An installed copy of IL-2 Great Battles or IL-2 Korea
- A Direct3D 11 capable GPU
- [Blender](https://www.blender.org/download/) for optional Blender/Cycles exports

## Project status

PRISM is under active development. This public repository contains packaged releases and release notes; application source code is maintained separately in a private repository.

PRISM is an independent community project and is not affiliated with or endorsed by 1C Game Studios, 777 Studios, or the Blender Foundation.